...
/*
    ...
    .state('Service.player', {
      url: '/player/:id?type_code&type_name',
      title: '선수관리',
      views: {
        '': {
          templateUrl: 'service/player.html',
          controller: 'PlayerCtrl as vm',
        },
        'my_team@Service.player': {
          templateUrl: 'service/entry-list.html',
          controller: 'EntryListCtrl as vm',
          resolve: {
            data: function () {
              return {
                multi_select: true,
        ...
        'ground@Service.player': {
          templateUrl: 'service/player-ground.html',
        },

        'oppo_team@Service.player': {
